...
Public Class fpr_pakai
    ...
    Private Sub btload_Click(sender As System.Object, e As System.EventArgs) Handles btload.Click
        ...
        Dim sql As String = String.Format("SELECT tr_pakai.nobukti, tr_pakai.tgl_pakai, tr_pakai.keperluan, tr_pakai.nama_pengambil, ms_barang.kd_barang, ms_barang.nama_barang, tr_pakai2.qty, tr_pakai2.satuan,ms_proyek.nama_group,ms_subproyek.nama_sub " & _
        ...
        Using fkar2 As New fpr_pakai2 With {.WindowState = FormWindowState.Maximized, .sql = sql, .periode = periode}
            fkar2.ShowDialog(Me)
        End Using
