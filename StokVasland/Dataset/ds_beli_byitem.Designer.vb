...
Partial Public Class ds_beli_byitem
    ...
    Partial Public Class DataTable1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddDataTable1Row(ByVal nobukti As String, ByVal no_nota As String, ByVal tanggal_beli As Date, ByVal kd_toko As String, ByVal nama_toko As String, ByVal kd_barang As String, ByVal nama_barang As String, ByVal qty As Integer, ByVal satuan As String, ByVal harga As Double, ByVal disc_rp As Decimal, ByVal jumlah As Double) As DataTable1Row
            Dim rowDataTable1Row As DataTable1Row = CType(Me.NewRow,DataTable1Row)
            Dim columnValuesArray() As Object = New Object() {nobukti, no_nota, tanggal_beli, kd_toko, nama_toko, kd_barang, nama_barang, qty, satuan, harga, disc_rp, jumlah}
