...
Public Class fopname2
    ...
    Private Function cekbukti(ByVal cn As OleDbConnection, ByVal sqltrans As OleDbTransaction) As String
        ...
        sql = String.Format("select max(nobukti) from tr_opname where  YEAR(tanggal)='{0}' and MONTH(tanggal)='{1}' and nobukti like '{2}%'", Year(ttgl.EditValue), Month(ttgl.EditValue), nobuktiawal)
    ...
    Private Function simpan2(ByVal cn As OleDbConnection, ByVal sqltrans As OleDbTransaction) As Boolean
        ...
        For i As Integer = 0 To dv1.Count - 1
            ...
            If dv1(i)("noid") <> 0 Then
                ...
                Clsmy.Insert_HistBarang(cn, sqltrans, tbukti.Text.Trim, tgl_old, dv1(i)("kd_barang").ToString, qty_sel, 0, "Opname (Edit)")

                ''3. insert to hist stok
                Clsmy.Insert_HistBarang(cn, sqltrans, tbukti.Text.Trim, ttgl.EditValue, dv1(i)("kd_barang").ToString, 0, qty_sel, "Opname (Edit)")
            ...
            Try
                ...
                If addstat = False Then
                    ...
                    If DateValue(tgl_old) <> DateValue(ttgl.EditValue) Then
                        Clsmy.Insert_HistBarang(cn, sqltrans, tbukti.Text.Trim, tgl_old, kdbar, qtykecil, 0, "Opname (Edit)")
